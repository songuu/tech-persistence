...
description: >
  ...
  Trigger: /caveman:compress <filepath>, Codex $caveman-compress <filepath>, or "compress memory file"
---
...
`/caveman:compress <filepath>`, Codex `$caveman-compress <filepath>`, or when user asks to compress a memory file.
...
On Windows, use `python -m scripts <absolute_filepath>` if `python3` is unavailable.
