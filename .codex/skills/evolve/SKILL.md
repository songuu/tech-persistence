---
name: evolve
description: Codex-compatible entry point for the former /evolve command. 将高置信度本能聚类进化为可复用的 skill、command 或 agent
---
...
聚类 2: "测试前置检查" (3 个本能, 平均置信度 0.72)
  ...
  建议: → 进化为 Rule (写入 .codex/rules/testing-patterns.md)
