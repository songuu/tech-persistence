...
- [2026-05-21] [sibling-eval/external-reference/identity-question-first] gsd-build/get-shit-done 评估 — 0 直接借鉴 + 2 follow-up + 13 拒绝 — 用户请求："研究下 <https://github.com/gsd-build/get-shit-done ，看下当前的架构有没有任何可以借鉴的地方"。 → `docs/solutions/2026-05-21-gsd-eval.md`
